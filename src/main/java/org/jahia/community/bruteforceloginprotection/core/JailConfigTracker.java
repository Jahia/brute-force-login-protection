 ...
 * {@code org.jahia.community.bruteforceloginprotection.jail-<discriminator>.cfg} produces one entry
...
public class JailConfigTracker implements ManagedServiceFactory {
    ...
    public static final String FACTORY_PID = "org.jahia.community.bruteforceloginprotection.jail";
